...
class MonteCarloSearch:
    ...
    def evaluateNode(self, node: Node, network: Network) -> None:
        ...
        for action, value in policy.items():
            node.children[action] = Node(self.newState(node.state, action), priorProb=value/policySum)
        return w_p
